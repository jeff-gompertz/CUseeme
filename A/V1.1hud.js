/* =========================================================
HUD.js v1.1 — Fixed-position drag system (iPad + iPhone safe)
========================================================= */

// 🟢 Make HUD draggable (pure fixed-position, no transform)
(function enableHUDDrag() {
  ...
  function startDrag(e) {
    if (e.target.closest('button')) return; // allow normal button taps
    dragging = true;
  ...
  function endDrag() {
    ...
    // Soft dock: snap near edges if close
    const rect = hud.getBoundingClientRect();
    const margin = 12;
